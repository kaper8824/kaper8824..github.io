...
hero1 = Sprite(margin,margin,('df1.gif'))
hero2 = Sprite(margin+(width +margin)*(n-1),margin,('df2.gif'))
hero3 = Sprite(margin,margin+(margin+height)*(n-1),('df3.gif'))
hero4 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-1),('df4.gif'))
hero5 = Sprite(margin,margin+(height +margin)*(n-2),('df5.gif'))
hero6 = Sprite(margin,margin+(height +margin)*(n-3),('df6.gif'))
hero7 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-2),('df7.gif'))
hero8 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-3),('df8.gif'))
hero9 = Sprite((width +margin)*(n-2)+margin,margin,('df9.gif'))                                
dum = True
