...
WHITE    = ( 255, 255, 255)
pygame.init()
n=6# количество клеток квадратного поля игры
width  = 100#ширина клетки( и объекта)
height = 100#высота клетки ( и объекта)
...
hero1 = Sprite((width +margin)*(n-6)+margin,margin+(height +margin)*(n-6),('madag_01.gif'))
hero2 = Sprite(margin+(width +margin)*(n-6),margin+(height +margin)*(n-5),('madag_02.gif'))
hero3 = Sprite(margin+(width +margin)*(n-6),margin+(height +margin)*(n-4),('madag_05.gif'))
hero4 = Sprite(margin+(width +margin)*(n-6),margin+(height +margin)*(n-3),('madag_03.gif'))
hero5 = Sprite(margin+(width +margin)*(n-6),margin+(height +margin)*(n-2),('madag_04.gif'))
hero6 = Sprite(margin+(width +margin)*(n-6),margin+(height +margin)*(n-1),('madag_06.gif'))
hero7 = Sprite((width +margin)*(n-5)+margin,margin+(height +margin)*(n-6),('madag_07.gif'))
hero8 = Sprite((width +margin)*(n-4)+margin,margin+(height +margin)*(n-6),('madag_08.gif'))
hero9 = Sprite((width +margin)*(n-3)+margin,margin+(height +margin)*(n-6),('madag_09.gif'))                                
hero10 = Sprite((width +margin)*(n-2)+margin,margin+(height +margin)*(n-6),('madag_10.gif'))
hero11 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-6),('madag_11.gif'))
hero12 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-5),('madag_12.gif'))
hero13 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-4),('madag_13.gif'))
hero14 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-3),('madag_14.gif'))
hero15 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-2),('madag_15.gif'))
hero16 = Sprite((width +margin)*(n-1)+margin,margin+(height +margin)*(n-1),('madag_16.gif'))
dum = True
